...
public class Common {
	 ...
	 */
	public static void dashStr(String title, String value) {
		SmartDashboard.putString(title + ": ", value);
	}
    ...
    /**
     * This will constrain an input value to a min and max value inclusive
     */
    public static double constrain(double input, double minOut, double maxOut){
        double output=input;
        if (output < minOut){
            output=minOut;
        }
